...
Log:
- Key decisions and the reasoning behind them (especially where you rejected the obvious approach)
- Problems that came up in real testing and how they were fixed
